...
export var UtilsCommon = {
    ...
    onNetworkStateChange: function(state: string) {
    ...
    toast: async function(message, header?, {color = 'success', position = 'bottom', duration = 1000} = {}) {
    ...
    alert: async function(message, header?, func?, options: {cssClass?, subHeader?, backdropDismiss?, htmlAttributes?} = {}) {
    ...
    resizeImage: function(base64image, { width = 0, height = 0, maxSize = 409600 } = {}): Promise<string> {
...
export interface UtilsCommonInterface {
    ...
    generateUUID(): string;
    onNetworkStateChange(state: string);
    setLang(lang: string);
    ...
    toast(message: string, header?: string, options?: {color?: string, position?: string, duration?: number}): Promise<any>;
    alert(message: string, header?: string, func?: Function, options?: {cssClass?: string, subHeader?: string, backdropDismiss?: boolean, htmlAttributes?}): Promise<any>;
    ...
    resizeImage(base64image: string, options?: {width?: number; height?: number; maxSize?: number}): Promise<string>;
