...
applyMixins(ApperyioHelperService, [UtilsCommon, UtilsHttp, UtilsAppClient, UtilsSecureStorage]);
...
export interface ApperyioHelperService extends UtilsCommonInterface, UtilsHttpInterface, UtilsAppClientInterface, UtilsSecureStorageInterface {}